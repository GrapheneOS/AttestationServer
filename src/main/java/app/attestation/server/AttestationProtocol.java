...
class AttestationProtocol {
    ...
    static final ImmutableMap<String, DeviceInfo> fingerprintsCustomOS = ImmutableMap
            ...
            .put("F0A890375D1405E62EBFD87E8D3F475F948EF031BBF9DDD516D5F600A23677E8",
                    new DeviceInfo(DEVICE_PIXEL_6, 100, 100, false /* uses new API */, true, OS_GRAPHENE))
            .put("439B76524D94C40652CE1BF0D8243773C634D2F99BA3160D8D02AA5E29FF925C",
                    new DeviceInfo(DEVICE_PIXEL_6_PRO, 100, 100, false /* uses new API */, true, OS_GRAPHENE))
            .put("08C860350A9600692D10C8512F7B8E80707757468E8FBFEEA2A870C0A83D6031",
                    new DeviceInfo(DEVICE_PIXEL_6A, 100, 100, false /* uses new API */, true, OS_GRAPHENE))
            .put("3EFE5392BE3AC38AFB894D13DE639E521675E62571A8A9B3EF9FC8C44FD17FA1",
                    new DeviceInfo(DEVICE_PIXEL_7, 200, 200, false /* uses new API */, true, OS_GRAPHENE))
            .put("BC1C0DD95664604382BB888412026422742EB333071EA0B2D19036217D49182F",
                    new DeviceInfo(DEVICE_PIXEL_7_PRO, 200, 200, false /* uses new API */, true, OS_GRAPHENE))
            .put("508D75DEA10C5CBC3E7632260FC0B59F6055A8A49DD84E693B6D8899EDBB01E4",
                    new DeviceInfo(DEVICE_PIXEL_7A, 200, 200, false /* uses new API */, true, OS_GRAPHENE))
            .build();
    static final ImmutableMap<String, DeviceInfo> fingerprintsStock = ImmutableMap
            ...
            .put("1B90B7D1449D697FB2732A7D2DFA405D587254593F5137F7B6E64F7A0CE03BFD",
                    new DeviceInfo(DEVICE_ONEPLUS_6T_A6013, 3, 4, false /* uses new API */, false, OS_STOCK))
            .put("4B9201B11685BE6710E2B2BA8482F444E237E0C8A3D1F7F447FE29C37CECC559",
                    new DeviceInfo(DEVICE_ONEPLUS_7_PRO_GM1913, 3, 4, false /* uses new API */, false, OS_STOCK))
            ...
            .put("1DD694CE00BF131AD61CEB576B7DCC41CF7F9B2C418F4C12B2B8F3E9A1EA911D",
                    new DeviceInfo(DEVICE_PIXEL_5A, 3, 4, false /* uses new API */, true, OS_STOCK))
            .put("0F6E75C80183B5DEC074B0054D4271E99389EBE4B136B0819DE1F150BA0FF9D7",
                    new DeviceInfo(DEVICE_PIXEL_6, 100, 100, false /* uses new API */, true, OS_STOCK))
            .put("42ED1BCA352FABD428F34E8FCEE62776F4CB2C66E06F82E5A59FF4495267BFC2",
                    new DeviceInfo(DEVICE_PIXEL_6_PRO, 100, 100, false /* uses new API */, true, OS_STOCK))
            .put("9AC4174153D45E4545B0F49E22FE63273999B6AC1CB6949C3A9F03EC8807EEE9",
                    new DeviceInfo(DEVICE_PIXEL_6A, 100, 100, false /* uses new API */, true, OS_STOCK))
            .put("8B2C4CD539F5075E8E7CF212ADB3DB0413FBD77D321199C73D5A473C51F2E10D",
                    new DeviceInfo(DEVICE_PIXEL_7, 200, 200, false /* uses new API */, true, OS_STOCK))
            .put("26AC4C60BEB1E378357CAD0C3061347AF8DF6FBABBB0D8CEA2445855EE01E368",
                    new DeviceInfo(DEVICE_PIXEL_7_PRO, 200, 200, false /* uses new API */, true, OS_STOCK))
            .put("003F1ADE9D476E612B00F2983E6AD7DCD15E6A80CC2DBB008DA7D6839ED73A8F",
                    new DeviceInfo(DEVICE_PIXEL_7A, 200, 200, false /* uses new API */, true, OS_STOCK))
            .put("72376CAACF11726D4922585732429FB97D0D1DD69F0D2E0770B9E61D14ADDE65",
                    new DeviceInfo(DEVICE_SM_A705FN, 3, 4, false /* uses new API */, false, OS_STOCK))
            ...
            .put("9D77474FA4FEA6F0B28636222FBCEE2BB1E6FF9856C736C85B8EA6E3467F2BBA",
                    new DeviceInfo(DEVICE_SM_G970F, 3, 4, false /* uses new API */, false, OS_STOCK))
            .put("08B2B5C6EC8F54C00C505756E1EF516BB4537B2F02D640410D287A43FCF92E3F",
                    new DeviceInfo(DEVICE_SM_G975F, 3, 4, false /* uses new API */, false, OS_STOCK))
            ...
            .put("E94BC43B97F98CD10C22CD9D8469DBE621116ECFA624FE291A1D53CF3CD685D1",
                    new DeviceInfo(DEVICE_SM_N970F, 3, 4, false /* uses new API */, false, OS_STOCK))
            ...
            .put("106592D051E54388C6E601DFD61D59EB1674A8B93216C65C5B3E1830B73D3B82",
                    new DeviceInfo(DEVICE_SM_T510, 3, 4, false /* uses new API */, false, OS_STOCK))
            ...
            .put("80BAB060807CFFA45D4747DF1AD706FEE3AE3F645F80CF14871DDBE27E14C30B",
                    new DeviceInfo(DEVICE_MOTO_G7, 3, 4, false /* uses new API */, false, OS_STOCK))
    ...
    static final ImmutableMap<String, DeviceInfo> fingerprintsStrongBoxCustomOS = ImmutableMap
            ...
            .put("08C860350A9600692D10C8512F7B8E80707757468E8FBFEEA2A870C0A83D6031",
                    new DeviceInfo(DEVICE_PIXEL_6A, 100, 100, false /* uses new API */, true, OS_GRAPHENE))
            .put("3EFE5392BE3AC38AFB894D13DE639E521675E62571A8A9B3EF9FC8C44FD17FA1",
                    new DeviceInfo(DEVICE_PIXEL_7, 100, 100, false /* uses new API */, true, OS_GRAPHENE))
            .put("BC1C0DD95664604382BB888412026422742EB333071EA0B2D19036217D49182F",
                    new DeviceInfo(DEVICE_PIXEL_7_PRO, 100, 100, false /* uses new API */, true, OS_GRAPHENE))
            .put("508D75DEA10C5CBC3E7632260FC0B59F6055A8A49DD84E693B6D8899EDBB01E4",
                    new DeviceInfo(DEVICE_PIXEL_7A, 100, 100, false /* uses new API */, true, OS_GRAPHENE))
            .build();
    static final ImmutableMap<String, DeviceInfo> fingerprintsStrongBoxStock = ImmutableMap
            ...
            .put("1DD694CE00BF131AD61CEB576B7DCC41CF7F9B2C418F4C12B2B8F3E9A1EA911D",
                    new DeviceInfo(DEVICE_PIXEL_5A, 4, 41, false /* uses new API */, true, OS_STOCK))
            .put("0F6E75C80183B5DEC074B0054D4271E99389EBE4B136B0819DE1F150BA0FF9D7",
                    new DeviceInfo(DEVICE_PIXEL_6, 100, 100, false /* uses new API */, true, OS_STOCK))
            .put("42ED1BCA352FABD428F34E8FCEE62776F4CB2C66E06F82E5A59FF4495267BFC2",
                    new DeviceInfo(DEVICE_PIXEL_6_PRO, 100, 100, false /* uses new API */, true, OS_STOCK))
            .put("9AC4174153D45E4545B0F49E22FE63273999B6AC1CB6949C3A9F03EC8807EEE9",
                    new DeviceInfo(DEVICE_PIXEL_6A, 100, 100, false /* uses new API */, true, OS_STOCK))
            .put("8B2C4CD539F5075E8E7CF212ADB3DB0413FBD77D321199C73D5A473C51F2E10D",
                    new DeviceInfo(DEVICE_PIXEL_7, 100, 100, false /* uses new API */, true, OS_STOCK))
            .put("26AC4C60BEB1E378357CAD0C3061347AF8DF6FBABBB0D8CEA2445855EE01E368",
                    new DeviceInfo(DEVICE_PIXEL_7_PRO, 100, 100, false /* uses new API */, true, OS_STOCK))
            .put("003F1ADE9D476E612B00F2983E6AD7DCD15E6A80CC2DBB008DA7D6839ED73A8F",
                    new DeviceInfo(DEVICE_PIXEL_7A, 100, 100, false /* uses new API */, true, OS_STOCK))
