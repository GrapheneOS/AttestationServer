...
import static app.attestation.server.attestation.AuthorizationList.UserAuthType.FINGERPRINT;
import static app.attestation.server.attestation.AuthorizationList.UserAuthType.PASSWORD;
import static app.attestation.server.attestation.AuthorizationList.UserAuthType.USER_AUTH_TYPE_ANY;
import static app.attestation.server.attestation.AuthorizationList.UserAuthType.USER_AUTH_TYPE_NONE;
import static app.attestation.server.attestation.Constants.KM_TAG_ACTIVE_DATE_TIME;
import static app.attestation.server.attestation.Constants.KM_TAG_ALGORITHM;
import static app.attestation.server.attestation.Constants.KM_TAG_ALLOW_WHILE_ON_BODY;
import static app.attestation.server.attestation.Constants.KM_TAG_ALL_APPLICATIONS;
import static app.attestation.server.attestation.Constants.KM_TAG_APPLICATION_ID;
import static app.attestation.server.attestation.Constants.KM_TAG_ATTESTATION_APPLICATION_ID;
import static app.attestation.server.attestation.Constants.KM_TAG_ATTESTATION_ID_BRAND;
import static app.attestation.server.attestation.Constants.KM_TAG_ATTESTATION_ID_DEVICE;
import static app.attestation.server.attestation.Constants.KM_TAG_ATTESTATION_ID_IMEI;
import static app.attestation.server.attestation.Constants.KM_TAG_ATTESTATION_ID_MANUFACTURER;
import static app.attestation.server.attestation.Constants.KM_TAG_ATTESTATION_ID_MEID;
import static app.attestation.server.attestation.Constants.KM_TAG_ATTESTATION_ID_MODEL;
import static app.attestation.server.attestation.Constants.KM_TAG_ATTESTATION_ID_PRODUCT;
import static app.attestation.server.attestation.Constants.KM_TAG_ATTESTATION_ID_SECOND_IMEI;
import static app.attestation.server.attestation.Constants.KM_TAG_ATTESTATION_ID_SERIAL;
import static app.attestation.server.attestation.Constants.KM_TAG_AUTH_TIMEOUT;
import static app.attestation.server.attestation.Constants.KM_TAG_BOOT_PATCH_LEVEL;
import static app.attestation.server.attestation.Constants.KM_TAG_CREATION_DATE_TIME;
import static app.attestation.server.attestation.Constants.KM_TAG_DEVICE_UNIQUE_ATTESTATION;
import static app.attestation.server.attestation.Constants.KM_TAG_DIGEST;
import static app.attestation.server.attestation.Constants.KM_TAG_EC_CURVE;
import static app.attestation.server.attestation.Constants.KM_TAG_IDENTITY_CREDENTIAL_KEY;
import static app.attestation.server.attestation.Constants.KM_TAG_KEY_SIZE;
import static app.attestation.server.attestation.Constants.KM_TAG_NO_AUTH_REQUIRED;
import static app.attestation.server.attestation.Constants.KM_TAG_ORIGIN;
import static app.attestation.server.attestation.Constants.KM_TAG_ORIGINATION_EXPIRE_DATE_TIME;
import static app.attestation.server.attestation.Constants.KM_TAG_OS_PATCH_LEVEL;
import static app.attestation.server.attestation.Constants.KM_TAG_OS_VERSION;
import static app.attestation.server.attestation.Constants.KM_TAG_PADDING;
import static app.attestation.server.attestation.Constants.KM_TAG_PURPOSE;
import static app.attestation.server.attestation.Constants.KM_TAG_ROLLBACK_RESISTANCE;
import static app.attestation.server.attestation.Constants.KM_TAG_ROLLBACK_RESISTANT;
import static app.attestation.server.attestation.Constants.KM_TAG_ROOT_OF_TRUST;
import static app.attestation.server.attestation.Constants.KM_TAG_RSA_PUBLIC_EXPONENT;
import static app.attestation.server.attestation.Constants.KM_TAG_TRUSTED_CONFIRMATION_REQUIRED;
import static app.attestation.server.attestation.Constants.KM_TAG_TRUSTED_USER_PRESENCE_REQUIRED;
import static app.attestation.server.attestation.Constants.KM_TAG_UNLOCKED_DEVICE_REQUIRED;
import static app.attestation.server.attestation.Constants.KM_TAG_USAGE_EXPIRE_DATE_TIME;
import static app.attestation.server.attestation.Constants.KM_TAG_USER_AUTH_TYPE;
import static app.attestation.server.attestation.Constants.KM_TAG_VENDOR_PATCH_LEVEL;
import static app.attestation.server.attestation.Constants.UINT32_MAX;
