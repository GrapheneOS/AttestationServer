...
import static app.attestation.server.attestation.Constants.KM_VERIFIED_BOOT_STATE_FAILED;
import static app.attestation.server.attestation.Constants.KM_VERIFIED_BOOT_STATE_SELF_SIGNED;
import static app.attestation.server.attestation.Constants.KM_VERIFIED_BOOT_STATE_UNVERIFIED;
import static app.attestation.server.attestation.Constants.KM_VERIFIED_BOOT_STATE_VERIFIED;
import static app.attestation.server.attestation.Constants.ROOT_OF_TRUST_DEVICE_LOCKED_INDEX;
import static app.attestation.server.attestation.Constants.ROOT_OF_TRUST_VERIFIED_BOOT_HASH_INDEX;
import static app.attestation.server.attestation.Constants.ROOT_OF_TRUST_VERIFIED_BOOT_KEY_INDEX;
import static app.attestation.server.attestation.Constants.ROOT_OF_TRUST_VERIFIED_BOOT_STATE_INDEX;
