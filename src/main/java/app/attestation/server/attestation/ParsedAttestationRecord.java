...
import static app.attestation.server.attestation.Constants.ATTESTATION_CHALLENGE_INDEX;
import static app.attestation.server.attestation.Constants.ATTESTATION_SECURITY_LEVEL_INDEX;
import static app.attestation.server.attestation.Constants.ATTESTATION_VERSION_INDEX;
import static app.attestation.server.attestation.Constants.KEYMASTER_SECURITY_LEVEL_INDEX;
import static app.attestation.server.attestation.Constants.KEYMASTER_VERSION_INDEX;
import static app.attestation.server.attestation.Constants.KEY_DESCRIPTION_OID;
import static app.attestation.server.attestation.Constants.KM_SECURITY_LEVEL_SOFTWARE;
import static app.attestation.server.attestation.Constants.KM_SECURITY_LEVEL_STRONG_BOX;
import static app.attestation.server.attestation.Constants.KM_SECURITY_LEVEL_TRUSTED_ENVIRONMENT;
import static app.attestation.server.attestation.Constants.SW_ENFORCED_INDEX;
import static app.attestation.server.attestation.Constants.TEE_ENFORCED_INDEX;
import static app.attestation.server.attestation.Constants.UNIQUE_ID_INDEX;
...
public class ParsedAttestationRecord {
  ...
  public static ParsedAttestationRecord createParsedAttestationRecord(List<X509Certificate> certs)
      throws IOException, KeyDescriptionMissingException {
